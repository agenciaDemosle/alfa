...
export default function WhatsAppFloat() {
  ...
  const message = encodeURIComponent('Hola, me gustaría obtener información sobre sus servicios de piscinas')
            ...
            <div className="bg-blue-500 p-4 flex items-center justify-between">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <div className="text-white/90 text-sm">En línea</div>
                </div>
              </div>
              <button
            ...
            <div className="p-4">
              <div className="bg-premium-black rounded-lg p-4 mb-4">
                <p className="text-gray-300 text-sm leading-relaxed">
                  👋 ¡Hola! ¿Cómo podemos ayudarte con tu proyecto de piscina?
                </p>
